...
namespace mem
{
	...
	struct address_base_t
	{
		...
		/// @param offset Additional offset to add to result
		/// @return Reference to this object
		inline address_base_t<ptr_type>& self_find_opcode_seq(std::vector<uint8_t> opcodes, ptrdiff_t offset = 0x0)
		{
		...
		inline t cast() const { return t(m_ptr); }
		...
		inline bool operator==(const address_base_t& other) const { return m_ptr == other.m_ptr; }
		inline bool operator!=(const address_base_t& other) const { return m_ptr != other.m_ptr; }
		inline bool operator<(const address_base_t& other) const { return m_ptr < other.m_ptr; }
		inline bool operator>(const address_base_t& other) const { return m_ptr > other.m_ptr; }
		inline bool operator<=(const address_base_t& other) const { return m_ptr <= other.m_ptr; }
